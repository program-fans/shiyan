...
/*2015.10.14 modify CONN_IO_BUF_CHUNKSIZE_DEFAULT (1024 --> 2048) by wolf-lone
 because 1024 < 1406 < 2048   1024 < 1500 < 2048
*/
#define CONN_IO_BUF_CHUNKSIZE_DEFAULT	2048
#define CONN_PORT_DEFAULT					80
