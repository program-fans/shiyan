...
#define DEBUG_EVENT
#ifdef DEBUG_EVENT
#define EVENT_DEBUG(fmt, args...) do{fprintf(stderr,"[%s:%d]: "fmt, __FUNCTION__, __LINE__, ##args); }while(0)
#else
#define EVENT_DEBUG(fmt, args...) do{}while(0)
#endif
...
***********************************************************************/
void DestroySelector(EventSelector *es)
{
...
*  Destroys handler
***********************************************************************/
void DestroyHandler(EventHandler *eh)
{
...
***********************************************************************/
void DoPendingChanges(EventSelector *es)
{
