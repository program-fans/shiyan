...
#if 1			/* wy,debug */
uint8_t *pCurveP = curve_p;
uint8_t *pCurveB = curve_b;
uint8_t *pCurveG = (uint8_t *)&curve_G;
uint8_t *pCurveN = curve_n;
uint32_t lCurveP = sizeof(curve_p);
uint32_t lCurveB = sizeof(curve_b);
uint32_t lCurveG = sizeof(curve_G);
uint32_t lCurveN = sizeof(curve_n);
#endif
